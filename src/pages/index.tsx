...
export default function Home() {
  ...
  // Only changing the return section, rest of the file stays exactly the same
return (
  <div className={`min-h-screen ${isDark ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`}>
    {/* Wallet button styles stay the same */}
    <style jsx global>{`
    ...
    <div className="fixed top-0 right-0 p-4 flex items-center gap-4">
      <button
        ...
        className={`p-2 rounded-lg ${
          isDark ? 'bg-gray-700 hover:bg-gray-600 text-white' : 'bg-gray-300 hover:bg-gray-400 text-gray-900'
        }`}
      >
        {isDark ? '☀️' : '🌙'}
      </button>
